...
<div class="login-box">
  <div class="login-logo">
    <a href="login.php"><b>DIF</b> LOGIN</a>
  </div>
  <?php
    echo $flashMessage->getFlashMessage($constants->FLASH_MESSAGE_SESSION_NAME);
  ?>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="mvc/action/loginAction.php" method="post">
