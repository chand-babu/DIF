                                    ...
                                    <div class="row mt-4 gallery-block" id="gallery-block-1">
                                        ...
                                        <div class="col-8">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="imageTitle-1" name="imageTitle-1" value="Title"
                                                class="form-control" placeholder="Enter Image Title">
                                            </div>
                                            <div class="form-group">
                                                <label for="imageDesc">Image Description</label>
                                                <textarea type="text" id="imageDesc-1" name="imageDesc-1"
                                                class="form-control" placeholder="Enter Image Description" rows="4"
        ...
        var template = `
                ...
                <div class="col-8">
                    <div class="form-group">
                        ...
                        placeholder="Enter Image Title" value="Title">
                    </div>
                    <div class="form-group">
                        ...
                        placeholder="Enter Image Description" rows="4">Description</textarea>
                    </div>
                </div>`;
        return template;
    }
