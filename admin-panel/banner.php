                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="text-right col-1" onclick="addBanner()">
...
aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <input type="hidden" id="bnr-model-id" value="">
      <div class="modal-body">
...
<script>
    $(document).ready(function() {
        var dtable = $('#bannerTable').DataTable({
            "processing": true,
            "ajax": {
                "url": "./mvc/action/banner/bannerListAction.php",
                "type": "POST", "dataSrc": ""
            },
            "columns": [
                { 
                    ...
                    "render": function(data, type, row){
                        return `<a href="./bannerEdit.php?id=${row.bnr_id}"><i class="fa fa-edit"></i></a> |
        ...
        $("#confirmModal").on("click",".btn-danger", function(){
            ...
            $.ajax({
                type: "GET",
                url: './mvc/action/banner/bannerDeleteAction.php',
                contentType: "application/json; charset=utf-8",
                data: { 'bnr_id': $("#bnr-model-id").val() },
